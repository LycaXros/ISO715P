...
public class EmpleadoController extends AbstractController<Empleado> {
    ...
    /**
    * Sets the "items" attribute with a collection of Rentadevolucion entities that are retrieved from Empleado
    ...
    /**
     * Sets the "selected" attribute of the Credencial controller
